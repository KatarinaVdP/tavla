...
const now = new Date()
let oneWeekFromNow: Date = new Date(now.getFullYear(), now.getMonth(), now.getDate() + 7);



export function FontSizePreview(): JSX.Element {
    const subLabels = [{
...
// useEffect(() => {
//     document.getElementById("tile-preview")?.style.fontSize = ((getFromLocalStorage(boardId + "-fontScale") as number) || 1) * 16
// }, [])
    ...
    return (
        ...
        <div className="tile" id="tile-preview">
            <div className="tilerow">
                <div className="tilerow__icon"><SubwayIcon color={colors.transport[IconColorType.CONTRAST].metro}></SubwayIcon></div>
                <div className="tilerow__texts">
                    <Heading3 className="tilerow__label">1 Bergkrystallen</Heading3>
                            ...
                            return (
                                <Fragment key={index}>
                                    <div className="tilerow__sublabel">
                                        ...
                                        {showDate && (
                                            <PreviewDate date={subLabel.departureTime} />
                                        )}
                                    </div>
